...
namespace TA
{
    ...
    public:
        ...
        {
            cls();
            printf("    ____        __  __  __  __    _____ __    _     ");
            printf("\033[5m           Wo\033[0m");
            printf("\033[32m⸜(* ॑o ॑* )⸝\033[0m\n");
            printf("   / __ )____ _/ /_/ /_/ /_/ /__ / ___// /_  (_)___ ");
            printf("\033[32m  (　ﾟ∀ﾟ)ﾉ♡\033[0m");
            printf("\033[5mAi\033[0m\n");
            printf("  / __  / __ `/ __/ __/ __/ / _ \\\\__ \\/ __ \\/ / __ \\");
            printf("\033[5m          Hua\033[0m");
            printf("\033[32mヾ(´ε`ヾ)\033[0m\n");
            printf(" / /_/ / /_/ / /_/ /_/ /_/ /  __/__/ / / / / / /_/ /");
            printf("\033[32m  (*´∀`)~♥\033[0m");
            printf("\033[5mHua\033[0m\n");
            printf("/_____/\\__,_/\\__/\\__/\\__/_/\\___/____/_/ /_/_/ .___/ ");
            printf("\033[5m    Lai Kai Chuan Luo\033[0m\n");
            printf("                                           /_/      ");
            printf("\033[32m     Σ>―(〃°ω°〃)♡→\033[0m\n");
        }
